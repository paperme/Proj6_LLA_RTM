...
\includegraphics[height=0.7cm]{../Total_intern/Final_report/Fig/logo.eps}}
...
\center
   \begin{figure}[ht]
        \begin{minipage}[b]{0.25\linewidth}
            \centering
            \includegraphics[width=\textwidth]{../Total_intern/figure/2dlayer/lowrank/figure_pvz_1_656.eps}

            \includegraphics[width=\textwidth]{../Total_intern/figure/2dlayer/lowrank/figure_pvx_1_656.eps}
            \caption{P-wave}
        \end{minipage}
        \hspace{0.5cm}
        \begin{minipage}[b]{0.25\linewidth}
            \centering
            \includegraphics[width=\textwidth]{../Total_intern/figure/2dlayer/lowrank/figure_svz_1_656.eps}

            \includegraphics[width=\textwidth]{../Total_intern/figure/2dlayer/lowrank/figure_svx_1_656.eps}
            \caption{S-wave}
        \end{minipage}
    \end{figure}
...
\begin{frame}{SEAM model}
  \includegraphics[width=0.7\textwidth]{/data/Doc/Project6_LLA_RTM/Fig/model_seam2d.eps}
\end{frame}
%%-----------------------------------------------------------
\begin{frame}{SEAM model}
\begin{itemize}
